...
- 官方地址： https://docs.oracle.com/javase/tutorial/java/nutsandbolts/_keywords.html
  ...
  ![关键字](../../assent/javase/2-keyword1.png)

  ![关键字](../../assent/javase/2-keyword2.png)
...
7. **补充：变量的分类-按声明的位置的不同**
   ...
   - 在方法体内部声明的变量称为**局部变量**。
     ...
     ![关键字](../../assent/javase/2-bianliang.png)
...
- 自动类型转换：容量小的类型自动转换为容量大的数据类型。数据类型按容量大小排序为：
  ...
  ![关键字](../../assent/javase/2-typezhuanhuan.png)
...
- 二进制的整数有如下三种形式：
  ...
  - 为什么要使用原码、反码、补码表示形式呢？
    ...
    - 二进制 --> 十进制
      ...
      ![进制转换](../../assent/javase/2-jinzhi1.png)
      
      > 原码与反码是帮助推导出补码而存在的！！！
      
    - 十进制 --> 二进制

      ![进制转换](../../assent/javase/2-jinzhi2.png)
...
- 十进制转成二进制除以2取余数
  ...
  ![进制转换](../../assent/javase/2-jinzhi3.png)

  ![进制转换](../../assent/javase/2-jinzhi4.png)

...
## 1. 程序流程控概述
> 流程控制语句是用来控制程序中各语句执行顺序的语句，可以把语句组合成能完成一定功其流程控制方式采用结构化程序设计中规定的三种基本流程结构，即：
>
> - 顺序结构
> - 分支结构
> - 循环结构
...
- Java中定义成员变量时采用合法的前向引用。如：
  ...
  ![流程控制](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/4-liucheng1.png)

## 3. 分支语句

### 3.1 if-else结构

![流程控制](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/4-liucheng2.png)

![流程控制](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/4-liucheng3.png)
...
- 使用说明
  ...
  ![流程控制](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/4-liucheng4.png)
...
![流程控制](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/4-liucheng5.png)
...
- 说明：
  ...
  ![流程控制](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/4-liucheng6.png)

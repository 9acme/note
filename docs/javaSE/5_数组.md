...
![数组](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/5-arr1.png)
...
![数组](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/5-arr2.png)
...
- 如果说可以把一维数组当成几何中的线性图形，那么二维数组就相当于是一个表格，像下图Excel中的表格一样。
	...
	-![数组](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/5-arr3.png)
...
- 案例1
  ...
  ![数组](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/5-arr4.png)
...
- 案例2
  ...
  ![数组](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/5-arr5.png)
...
- 案例3
  ...
  ![数组](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/5-arr6.png)
...
- 案例4
  ...
  ![数组](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/5-arr7.png)

### 3.4 练习

- 练习1

  ![数组](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/5-arr8.png)
...
- 练习2
  ...
  ![数组](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/5-arr9.png)
...
- 思考：上述 array1 和 array2 是什么关系？
  ...
  ![数组](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/5-arr10.png)
...
- 拓展：修改题目，实现 array2 对 array1 数组的复制
  ...
  ![数组](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/5-arr11.png)
...
- 二分法查找算法
  ...
  ![数组](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/5-arr12.png)
...
- 基本思想
  ...
  ![数组](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/5-arr13.gif)
...
- **排序思想**:
  ...
  ![数组](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/5-arr14.gif)
...
![数组](https://cdn.jsdelivr.net/gh/9acme/assets@note/javase/5-arr15.png)

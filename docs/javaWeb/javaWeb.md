...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409133841952.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409133930874.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409133945187.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134001206.png)
...
* 方式一：将Web工程目录拷贝到Tomcat的Webapps目录下即可 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134018317.png)

访问：http://localhost:8080/kuangstudy

* 方式二：找到Tomcat下的==\Catalina\localhost==，创建如下的配置文件 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134026694.png) ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134034355.png) ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134047558.png)
...
* 手动拖动html页面到浏览器，这个时候浏览器中的地址如下： ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134102731.png) 他使用的是File：//协议，file协议表示告诉浏览器 我们直接读取file：协议后面的路径，解析展示在浏览器上即可
* 在地址栏中输入地址访问：http：//ip:port/工程名/资源名 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134119640.png) 所使用的协议是Http协议，背后的原因完全不同 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134128483.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134147898.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134157890.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134225596.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134244621.png)

![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134252891.png)

![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134300577.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134315319.png)

![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134323560.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134338130.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134401301.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134414178.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134437256.png)

![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134445244.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134459960.png)
...
* 什么是域对象
  ...
  - 这里的域指的是存取数据的操作范围，即整个Web工程存数据取数据删除数据Mapput（）get（）remove（）域对象setAttribute（）getAttribute（）removeAttribute（）
* ServletContext类的作用
  - 获取Web.xml中配置的上下文参数
...
* 什么是Http协议： 所谓的Http协议，就是指，客户端和服务器之间通信时，发送的数据需要遵守的规则，叫Http协议 HTTP协议中的数据又叫报文
* 请求的Http协议格式 请求又分为Get请求和Post请求两种
* Get请求
  - 请求行
    + 请求方式 GET
    + 请求的资源路径【+？+请求参数】
    + 请求的协议的版本号 HTTP/1.1
  - 请求头
    + key：value 不同的键值对表示不同的含义 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134544229.png)
* Post请求
  - 请求行
    + 请求方式 POST
    + 请求的资源路径【+？+请求参数】
    + 请求的协议的版本号 HTTP/1.1
  - 请求头
    + key：value 不同的键值对表示不同的含义 **空行**
  - 请求体 ------------>发送给服务器的数据 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134554602.png)
* 常用请求头
  - Accept：客户端可以接受的类型
...
* 相应的Http协议格式
  - 相应行
    ...
    + 响应状态描述符
  - 响应头
    + key：value 不同的响应头对表示不同的含义 **空行**
  - 响应体---------> 就是回传给客户端的数据 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134610268.png)
* 常用的响应码
  - 200 表示请求成功
  - 302 表示请求重定向
  - 404 表示请求收到了，但是你要的数据不存在
  - 500 表示服务器已经收到请求，但是服务器内部错误（代码）
* MIME数据类型 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134620250.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134708906.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134718886.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134735689.png)
...
* 请求转发是指服务器收到请求后，从一个资源跳到另一个资源的操作叫请求转发 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134755645.png)
* 请求转发的特点：
  - 浏览器地址栏没有变化
  - 他们是一次请求
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134833946.png)
...
<body>
    ...
    <a href="a/b/c.html">a/b/c.htmla>
    <a href="http://localhost:8080/02_ServletRequest/forwardc">请求转发a>
body>
html>
```
...
* 两个输出流的说明字节流getOutputStream（）常用于下载（传递二进制数据）字符流getWriter（）常用于回传字符串
  - 两个流只能使用一个，使用了字节流就不能再使用字符流，反之亦然，否则就会报错 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134908107.png)
* 如何往客户端回传数据
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409134937695.png)
...
* 当我们第一次访问jsp页面的时候，Tomcat会帮我们帮jsp页面翻译成一个java源文件，并且把他进行编译为.class字节码程序，我们打开java源文件不难发现其里面的内容是： ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135007249.png) ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135013433.png) ​ ​ 跟踪源代码发现，HttpJspBase类直接继承了HttpServlet类，也就是说，Jsp翻译出来的类，间接继承了HttpServlet类，即翻译出来的是一个Servlet程序，并且在底层实现，也是通过输出流，将html页面数据回传给客户端 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135024277.png)
...
* buffer属性：设置out缓冲区大小，默认是8kb ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135042750.png)
...
```
  ...
  - 特点：
    ...
    + 由于表达式脚本翻译的内容都在_jspService（）方法中，所以_ jspService（）中的所有对象（request、reponse）都可以使用
    + 表达式脚本中的表达式不能以分号结束
...
```
  ...
  - 特点：
    ...
    + 代码脚本由于翻译到__jspService（）方法中，所以在_jspService（）方法中的先有对象都可以直接使用
...
* 虽然四个域对象都可以存取数据，在使用上他们是有优先顺序的，优先顺序分别是：他们从小到大的存取范围（基于对内存的优化），即： pageContext -------------> request ------------> session -----------------> application
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135114366.png)
...
* 静态包含（推荐）
  - 静态包含的特点：
    + 静态包含不会翻译被包含的jsp页面
    + 静态包含其实是把被包含的jsp页面代码拷贝到包含的位置执行输出 main.jsp
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/2021040913513895.png)
...
```
* 使用步骤如下：
  - 编写一个类去实现ServletContextListener接口 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135204148.png)
  - 实现其两个回调方法
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135228146.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135240111.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135248708.png)
...
* empty运算 empty运算可以判断一个数据是否为空，如果为空，输出true，不为空输出false 以下几种情况为空：
  - 值为null值
  - 值为空串
  - 值是Object类型数组，长度为0
  - list集合，元素个数为0
...
变量类型作用pageContextPageContextImpl可以获取jsp中的九大内置对象pageScopeMap
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135328805.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135338356.png)
* cookie
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135346116.png)
* initParam
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135354563.png)
...
* JSTL由五个不同功能的标签库组成 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135424313.png)

![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135431138.png)
...
* 先导入JSTL标签库的jar包 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135441647.png)
* 使用taglib指令引入标签库
...
* set标签
  - 作用：set标签可以往域中保存数据 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135458962.png)
...
```
* choose、when、otherwise 作用：多路判断，跟switch、case、default非常接近
...
```
* foreach标签所有属性组合使用 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135518364.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135538428.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135551163.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135612317.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135635597.png)
...
* 需要导入两个jar包 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135651135.png)
* 常用的类
  - ServletFileUpload类：用于解析上传的数据
  - FileItem类：表示每一个表单项 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135714869.png) ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135723793.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135744913.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135804190.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135844731.png)
...
* 谷歌浏览器： ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135919272.png)
* 火狐浏览器 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135925778.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409135954633.png)
...
```
  - Session超时的概念介绍 ![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409140005744.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409140020923.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409140037528.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/javaWeb/20210409140058459.png)
...
* json的创建 json是由键值对组成，并且由大括号包围，每个键由引号引起来，键和值之间使用冒号进行分隔，多组键值对之间使用逗号进行分隔
...
```
* json的访问 json本身就是一个对象，json中的key我们可以理解为对象中的一个属性，json中的key访问就跟访问对象的属性一样：json对象.key
...
public void test3(){
    ...
    Map<Integer,Person> personMap2 =gson.fromJson(personMapJsonString, (Type) new TypeToken<HashMap<Integer,Person>>(){}.getType());

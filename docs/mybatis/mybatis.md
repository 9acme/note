...
![img](https://cdn.jsdelivr.net/gh/9acme/assets@note/mybatis/04.png)
...
![img](https://cdn.jsdelivr.net/gh/9acme/assets@note/mybatis/05.png)

![img](https://cdn.jsdelivr.net/gh/9acme/assets@note/mybatis/07.png)

------

![根据配置文件创建SQLSessionFactory](https://cdn.jsdelivr.net/gh/9acme/assets@note/mybatis/08.png)
...
![openSession获取sqlSession对象](https://cdn.jsdelivr.net/gh/9acme/assets@note/mybatis/09.png)
...
![getMapper返回接口的代理对象包含了SqlSession对象](https://cdn.jsdelivr.net/gh/9acme/assets@note/mybatis/10.png)

------

![查询流程](https://cdn.jsdelivr.net/gh/9acme/assets@note/mybatis/11.png)

![查询流程总结](https://cdn.jsdelivr.net/gh/9acme/assets@note/mybatis/12.png)
...
![img](https://cdn.jsdelivr.net/gh/9acme/assets@note/mybatis/06.png)
...
![img](https://cdn.jsdelivr.net/gh/9acme/assets@note/mybatis/13.png)

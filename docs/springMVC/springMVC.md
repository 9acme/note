...
```
 ...
 ![img](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/Image5.png)
...
1. `<mvc:default-servlet-handler/> ` 与 `<mvc:annotation-driven/>`
   ...
   3. 都加上
      ...
      - handleAdapter
         ...
         ![img](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/Image14.png)
...
- ```java
  ...
  ![1605344171944](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/1605344171944.png)

  结果：

  ![1605344146604](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/1605344146604.png)
...
![](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/1605346124074.png)
...
![1605347056358](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/1605347056358.png)

#### `ResponseEntity<String>`

- 可以设置响应头

![1605348403547](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/1605348403547.png)
...
![1605406824829](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/1605406824829.png)

![1605406991249](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/1605406991249.png)
...
![1605356444254](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/1605356444254.png)
...
3. 拦截器的运行流程
   ...
   ![1605412059743](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/1605412059743.png)
   ...
   1. 只要preHandle不放行就没有以后的流程；
      ...
      <img src="https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/1605412516902.png" alt="1605412516902"  />

   2. 只要放行了，afterCompletion都会执行；

      - 目标方法出现异常，afterCompletion也会执行

        ![1605412714078](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/1605412714078.png)

### 12.2 多个拦截器



![1605414721082](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/1605414721082.png)
...
preHandle：
 ...
 ![img](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/Image46.png)
...
![1605429240237](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/1605429240237.png)

![1605429248620](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/1605429248620.png)
...
加了MVC异常处理，默认就是这个几个HandlerExceptionResolver
 ...
 ![img](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/Image52.png)
...
![1605446703449](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/1605446703449.png)
...
如：HttpRequestMethodNotSupportedException。如果没人处理则它自己处理
 ...
 ![img](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/Image51.png)
...
通过配置的方式进行异常处理
 ...
 ![img](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/Image54.png)
...
```
 ...
 ![img](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/Image55.png)
...
- **父容器不能引用子容器的组件**
 ...
 ![img](https://cdn.jsdelivr.net/gh/9acme/assets@note/springMVC/Image56.png)